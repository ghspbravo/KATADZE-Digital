...
export let logoAnimation = () => $(document).ready(function ($) {
    // let $body = $('body');
...
(function ($) {
    ...
    Distortion.prototype.useGlitch = function () {
        ...
        if (_.glitch) {
            ...
            for (var i = 0; i < randInt(1, 13); i++) {
                ...
                try {_.context.drawImage(_.canvas, 0, y, spliceWidth, spliceHeight, x, y, spliceWidth, spliceHeight);
    ...
    Distortion.prototype.useBlur = function () {
        ...
        if (_.blur) {
            try {_.split.context.drawImage(_.canvas, 0, 0);
